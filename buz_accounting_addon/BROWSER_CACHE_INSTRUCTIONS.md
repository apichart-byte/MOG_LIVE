...
grep -c "def unlink(self):" /opt/instance1/odoo17/custom-addons/buz_accounting_addon/models/account_receipt_voucher.py
# Should show: 2
```
...
```bash
cd /opt/instance1/odoo17/custom-addons/buz_accounting_addon
