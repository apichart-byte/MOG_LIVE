...
def post_init_hook(cr, registry):
    """
    Post-installation hook to update legacy tax invoice records:
    1. Set company_id for records without it
    2. Set tax_amount = balance for legacy records that don't have tax_amount
    """
    _logger.info("Starting post_init_hook for l10n_th_account_tax_report")
    ...
    _logger.info("Completed post_init_hook for l10n_th_account_tax_report")
